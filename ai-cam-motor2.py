...
# Movement gains
# Higher = motor target changes faster
# Lower = smoother/slower reaction
BASE_GAIN = 3.0
SHOULDER_GAIN = 4.0
ELBOW_GAIN = 6.0

# Separate max step values for smoother coordinated movement
BASE_MAX_STEP = 2.5
SHOULDER_MAX_STEP = 1.2
ELBOW_MAX_STEP = 2.0
...
def step_toward(current, target, max_step):
    ...
    This makes motor movement smoother.
    """
    diff = target - current
...
try:
    while True:
        ...
        if person_box is not None:
            ...
            # ------------------------------
            # SHOULDER TRACKING - UPDATED
            # ------------------------------
            # Shoulder now reacts to both vertical position and person size.
            # This makes it move more reliably.
            ...
            # ELBOW TRACKING
            # ------------------------------
            # Elbow uses both person size and vertical position.
        ...
        # Each motor has its own smoothness value.
        # ====================================================
